...
class Ui_CreateProtoForm(object):
    def setupUi(self, CreateProtoForm):
        ...
        self.radioButton = QtWidgets.QRadioButton(CreateProtoForm)
        self.radioButton.setGeometry(QtCore.QRect(100, 10, 89, 16))
        self.radioButton.setObjectName("radioButton")
        self.radioButton_2 = QtWidgets.QRadioButton(CreateProtoForm)
        self.radioButton_2.setGeometry(QtCore.QRect(220, 10, 89, 16))
    ...
    def retranslateUi(self, CreateProtoForm):
        ...
        self.radioButton.setText(_translate("CreateProtoForm", "请求消息"))
        self.radioButton_2.setText(_translate("CreateProtoForm", "广播消息"))

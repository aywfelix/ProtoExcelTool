...
class Ui_AddTmplForm(object):
    def setupUi(self, AddTmplForm):
        ...
        self.cBbxLang.setGeometry(QtCore.QRect(80, 40, 281, 22))
    ...
    def retranslateUi(self, AddTmplForm):
        ...
        self.cBbxLang.setItemText(1, _translate("AddTmplForm", "golang"))
        self.cBbxLang.setItemText(2, _translate("AddTmplForm", "csharp"))
        self.cBbxLang.setItemText(3, _translate("AddTmplForm", "lua"))

...
class Ui_SettingForm(object):
    ...
    def retranslateUi(self, SettingForm):
        ...
        self.pushButton_4.setText(_translate("SettingForm", "选择"))
        self.label_2.setText(_translate("SettingForm", "生成proto文件路径："))
        self.pushButton_5.setText(_translate("SettingForm", "选择"))
        self.pushButton_6.setText(_translate("SettingForm", "选择"))

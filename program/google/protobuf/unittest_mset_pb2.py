...
_NESTEDTESTMESSAGESETCONTAINER = _descriptor.Descriptor(
  name='NestedTestMessageSetContainer',
  full_name='protobuf_unittest.NestedTestMessageSetContainer',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='container', full_name='protobuf_unittest.NestedTestMessageSetContainer.container', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='child', full_name='protobuf_unittest.NestedTestMessageSetContainer.child', index=1,
...
_NESTEDTESTINT = _descriptor.Descriptor(
  name='NestedTestInt',
  full_name='protobuf_unittest.NestedTestInt',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='a', full_name='protobuf_unittest.NestedTestInt.a', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='child', full_name='protobuf_unittest.NestedTestInt.child', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_TESTMESSAGESETEXTENSION3 = _descriptor.Descriptor(
  ...
  full_name='protobuf_unittest.TestMessageSetExtension3',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='msg', full_name='protobuf_unittest.TestMessageSetExtension3.msg', index=0,
  ...
  extensions=[
    _descriptor.FieldDescriptor(
      name='message_set_extension', full_name='protobuf_unittest.TestMessageSetExtension3.message_set_extension', index=0,
      number=195273129, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=True, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
...
_NESTEDTESTMESSAGESETCONTAINER.fields_by_name['container'].message_type = _TESTMESSAGESETCONTAINER
_NESTEDTESTMESSAGESETCONTAINER.fields_by_name['child'].message_type = _NESTEDTESTMESSAGESETCONTAINER
...
_NESTEDTESTINT.fields_by_name['child'].message_type = _NESTEDTESTINT
_TESTMESSAGESETEXTENSION3.fields_by_name['msg'].message_type = _NESTEDTESTINT
...
DESCRIPTOR.message_types_by_name['NestedTestMessageSetContainer'] = _NESTEDTESTMESSAGESETCONTAINER
...
DESCRIPTOR.message_types_by_name['NestedTestInt'] = _NESTEDTESTINT
...
NestedTestMessageSetContainer = _reflection.GeneratedProtocolMessageType('NestedTestMessageSetContainer', (_message.Message,), {
  'DESCRIPTOR' : _NESTEDTESTMESSAGESETCONTAINER,
  '__module__' : 'google.protobuf.unittest_mset_pb2'
  # @@protoc_insertion_point(class_scope:protobuf_unittest.NestedTestMessageSetContainer)
  })
_sym_db.RegisterMessage(NestedTestMessageSetContainer)
...
NestedTestInt = _reflection.GeneratedProtocolMessageType('NestedTestInt', (_message.Message,), {
  'DESCRIPTOR' : _NESTEDTESTINT,
  '__module__' : 'google.protobuf.unittest_mset_pb2'
  # @@protoc_insertion_point(class_scope:protobuf_unittest.NestedTestInt)
  })
_sym_db.RegisterMessage(NestedTestInt)
...
_TESTMESSAGESETEXTENSION3.extensions_by_name['message_set_extension'].message_type = _TESTMESSAGESETEXTENSION3
google_dot_protobuf_dot_unittest__mset__wire__format__pb2.TestMessageSet.RegisterExtension(_TESTMESSAGESETEXTENSION3.extensions_by_name['message_set_extension'])

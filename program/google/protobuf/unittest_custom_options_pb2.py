...
_TESTMESSAGEWITHCUSTOMOPTIONS_MAPFIELDENTRY = _descriptor.Descriptor(
  name='MapFieldEntry',
  full_name='protobuf_unittest.TestMessageWithCustomOptions.MapFieldEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='protobuf_unittest.TestMessageWithCustomOptions.MapFieldEntry.key', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='value', full_name='protobuf_unittest.TestMessageWithCustomOptions.MapFieldEntry.value', index=1,
...
_TESTMESSAGEWITHCUSTOMOPTIONS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='map_field', full_name='protobuf_unittest.TestMessageWithCustomOptions.map_field', index=2,
      number=3, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\301\340\303\03590\000\000\000\000\000\000', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
  ],
  extensions=[
  ],
  nested_types=[_TESTMESSAGEWITHCUSTOMOPTIONS_MAPFIELDENTRY, ],
  enum_types=[
...
_TESTMESSAGEWITHCUSTOMOPTIONS_MAPFIELDENTRY.containing_type = _TESTMESSAGEWITHCUSTOMOPTIONS
_TESTMESSAGEWITHCUSTOMOPTIONS.fields_by_name['map_field'].message_type = _TESTMESSAGEWITHCUSTOMOPTIONS_MAPFIELDENTRY
...
TestMessageWithCustomOptions = _reflection.GeneratedProtocolMessageType('TestMessageWithCustomOptions', (_message.Message,), {
  ...
  'MapFieldEntry' : _reflection.GeneratedProtocolMessageType('MapFieldEntry', (_message.Message,), {
    'DESCRIPTOR' : _TESTMESSAGEWITHCUSTOMOPTIONS_MAPFIELDENTRY,
    '__module__' : 'google.protobuf.unittest_custom_options_pb2'
    # @@protoc_insertion_point(class_scope:protobuf_unittest.TestMessageWithCustomOptions.MapFieldEntry)
    })
  ,
...
_sym_db.RegisterMessage(TestMessageWithCustomOptions.MapFieldEntry)

...
class Ui_ProtoWindow(object):
    ...
    def retranslateUi(self, ProtoWindow):
        ...
        self.rBtnCom.setText(_translate("ProtoWindow", "共用"))
        self.rBtnServer.setText(_translate("ProtoWindow", "服务器"))
        self.label_11.setText(_translate("ProtoWindow", "枚举类型："))
        self.rBtnClient.setText(_translate("ProtoWindow", "客户端"))
        ...
        self.btnExportPb.setText(_translate("ProtoWindow", "导出pb协议"))
        self.btnSetting.setText(_translate("ProtoWindow", "设置"))
        self.btnExportEnum.setText(_translate("ProtoWindow", "导出枚举"))
        self.btnExportTable.setText(_translate("ProtoWindow", "导出配置表"))

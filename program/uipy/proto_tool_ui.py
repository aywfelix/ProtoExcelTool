...
class Ui_ProtoWindow(object):
    def setupUi(self, ProtoWindow):
        ...
        self.tBtnConn = QtWidgets.QToolButton(self.tab_3)
        self.tBtnConn.setGeometry(QtCore.QRect(10, 10, 151, 51))
        self.tBtnConn.setObjectName("tBtnConn")
        self.tBtnDisconn = QtWidgets.QToolButton(self.tab_3)
        self.tBtnDisconn.setGeometry(QtCore.QRect(340, 10, 151, 51))
        self.tBtnDisconn.setObjectName("tBtnDisconn")
        self.tBtnClearMsg = QtWidgets.QToolButton(self.tab_3)
        self.tBtnClearMsg.setGeometry(QtCore.QRect(670, 10, 151, 51))
        self.tBtnClearMsg.setObjectName("tBtnClearMsg")
        ...
        self.tEtResp = QtWidgets.QPlainTextEdit(self.tab_3)
        self.tEtResp.setGeometry(QtCore.QRect(10, 360, 861, 351))
    ...
    def retranslateUi(self, ProtoWindow):
        ...
        self.tBtnConn.setText(_translate("ProtoWindow", "连接到服务器"))
        self.tBtnDisconn.setText(_translate("ProtoWindow", "断开连接"))
        self.tBtnClearMsg.setText(_translate("ProtoWindow", "清空文本框"))

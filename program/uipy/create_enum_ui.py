...
class Ui_CreateEnumForm(object):
    def setupUi(self, CreateEnumForm):
        ...
        sizePolicy.setHeightForWidth(self.tBvEnum.sizePolicy().hasHeightForWidth())
        self.tBvEnum.setSizePolicy(sizePolicy)
        self.tBvEnum.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOn)
        self.tBvEnum.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.AdjustIgnored)
        self.tBvEnum.setAutoScroll(False)
        self.tBvEnum.setTabKeyNavigation(False)
        self.tBvEnum.setProperty("showDropIndicator", False)
        self.tBvEnum.setDragDropOverwriteMode(False)
        self.tBvEnum.setWordWrap(False)
        self.tBvEnum.setCornerButtonEnabled(False)

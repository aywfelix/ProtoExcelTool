...
class Ui_CreateEnumForm(object):
    def setupUi(self, CreateEnumForm):
        ...
        self.bTnEnumUpdate = QtWidgets.QPushButton(CreateEnumForm)
        self.bTnEnumUpdate.setGeometry(QtCore.QRect(280, 610, 75, 23))
    ...
    def retranslateUi(self, CreateEnumForm):
        ...
        self.bTnEnumUpdate.setText(_translate("CreateEnumForm", "修改"))
